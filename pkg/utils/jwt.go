...
func RefreshToken(refreshToken, secret string, expiry time.Duration) (string, error) {
	...
	return GenerateToken(claims.UserID, claims.Email, claims.Role, secret, expiry)
}
